...
USER_ID = os.getenv("SKILLCAPTAIN_USER_ID")
JSESSIONID1 = os.getenv("SKILLCAPTAIN_JSESSIONID1")
JSESSIONID2 = os.getenv("SKILLCAPTAIN_JSESSIONID2")
...
# ===============================
# SkillCaptain API Call
# ===============================
def call_skillcaptain_api(prompt, user_id=USER_ID):
    ...
    headers = {
        ...
        'Cookie': f'JSESSIONID={JSESSIONID1}; JSESSIONID={JSESSIONID2}'
    }
...
user_id = st.sidebar.text_input("User ID", value=USER_ID)
